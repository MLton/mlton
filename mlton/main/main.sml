...
val options = 
   ...
   in [
	...
	boolRef Native.moveHoist),
       (Expert, "native-new-gen-transfer", " {false|true}",
	"use new gen transfer",
	boolRef Native.newGenTransfer),
       (Expert, "native-ready", " {true|false}",
	"use new gen transfer ready",
	boolRef Native.ready),
	...
	boolRef showTypes),
       (Expert, "stack-cont", " {false|true}", "force continuation formals to stack",
	boolRef stackCont),
