...
structure GL =
	...
	local
	    (* open the library *)
	    val dlh = Dynlib.dlopen {lib="libmosmlgl.so",
				     flag= Dynlib.RTLD_LAZY,
				     global=false }
	in

	val glAccum : GLenum -> real -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glAccum")
	val glArrayElement : int -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glArrayElement")
	val glBitmapApp : int * int * real * real * real * real * Word8Vector.vector -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glBitmap")
	fun glBitmap (a0 : int) (a1 : int) (a2 : real) (a3 : real)
	    (a4 : real) (a5 : real) (a6 : Word8Vector.vector) =
		glBitmapApp (a0, a1, a2, a3, a4, a5, a6)
	val glBlendFunc : GLenum -> GLenum -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glBlendFunc")
	val glClearIndex : real -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glClearIndex")
	val glClearStencil : int -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glClearStencil")
	fun glColorPointer (a : int)
	    (b : GLenum) (c : int) (d: 'a list) : unit =
		Dynlib.app4 (Dynlib.dlsym dlh "mosml_glColorPointer") a b c d
	val glCopyPixels : int -> int -> int -> int -> GLenum -> unit =
		Dynlib.app5 (Dynlib.dlsym dlh "mosml_glCopyPixels")
	val glDepthRange : real -> real -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glDepthRange")
	val glDrawArrays : GLenum -> int -> int -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glDrawArrays")
	val glDrawBuffer : GLenum -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glDrawBuffer")
	val glDrawElements : GLenum -> int -> GLenum -> int list -> unit =
		Dynlib.app4 (Dynlib.dlsym dlh "mosml_glDrawElements")
	val glDrawPixels : int -> int -> GLenum -> GLenum -> Word8Vector.vector -> unit =
		Dynlib.app5 (Dynlib.dlsym dlh "mosml_glDrawPixels")
	val glEnableClientState : GLenum -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glEnableClientState")
	val glFinish : unit -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glFinish")
	val glInterleavedArrays : GLenum -> int -> real list -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glInterleavedArrays")
	val glIsEnabled : GLenum -> int =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glIsEnabled")
	val glLineWidth : real -> unit = 
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glLineWidth")
	val glPixelMapfv : GLenum -> int -> real list -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glPixelMapfv")
	val glPixelStoref : GLenum -> real -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glPixelStoref")
	val glPixelStorei : GLenum -> int -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glPixelStorei")
	val glPixelTransferf : GLenum -> real -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glPixelTransferf")
	val glPixelTransferi : GLenum -> int -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glPixelTransferi")
	val glPixelZoom : real -> real -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glPixelZoom")
	val glPopAttrib : unit -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glPopAttrib")
	val glPushAttrib : GLenum -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glPushAttrib")
	val glRasterPos2i : int -> int -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glRasterPos2i")
	val glRasterPos2f : real -> real -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glRasterPos2f")
	val glReadPixelsApp : int * int * int * 
	    int * GLenum * GLenum * Word8Vector.vector -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glReadPixels")
	fun glReadPixels (a0 : int) (a1 : int) (a2 : int) (a3 : int)
	    (a4 : GLenum) (a5 : GLenum) (a6 : Word8Vector.vector) =
		glReadPixelsApp (a0, a1, a2, a3, a4, a5, a6)
	fun glVertexPointer (a : int)
	    (b : GLenum) (c : int) (d: 'a list) : unit =
		Dynlib.app4 (Dynlib.dlsym dlh "mosml_glVertexPointer") a b c d


	val glBegin : GLenum -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glBegin")
	val glClear : GLenum -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glClear")
	val glClearColor : real -> real -> real -> real -> unit =
		Dynlib.app4 (Dynlib.dlsym dlh "mosml_glClearColor")


#endif /* MOSML_SOURCE */
#ifdef MLTON_SOURCE
        val clearColor = _import "w_glClearColor" 
			       : real * real * real * real -> unit;
        val clear = _import "glClear" stdcall: GLenum -> unit;
        val flush = _import "glFlush" stdcall: unit -> unit;
#endif /* MLTON_SOURCE */
#ifdef MOSML_SOURCE
	val glClearDepth : real -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glClearDepth")
	val glDepthFunc : GLenum -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glDepthFunc")
	val glDisable : GLenum -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glDisable")
	val glFrustumApp : real * real * real * real * real * real -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glFrustum")
	fun glFrustum (a0 : real) (a1 : real) (a2 : real) (a3 : real)
	    (a4 : real) (a5 : real) =
		glFrustumApp (a0, a1, a2, a3, a4, a5)
	val glColor3d : real -> real -> real -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glColor3d")
	val glColor3f : real -> real -> real -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glColor3d")
	val glColor3ub : Word8.word -> Word8.word -> Word8.word -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glColor3ub")
	val glColor4d : real -> real -> real -> real -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glColor3d")
	val glColor4f : real -> real -> real -> real -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glColor3d")
	val glColor4ub : Word8.word -> Word8.word -> Word8.word -> Word8.word -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glColor3ub")
	val glColorMaterial : GLenum -> GLenum -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glColorMaterial")
	val glEnable : GLenum -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glEnable")
	val glEnd : unit -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glEnd")
	val glEndList : unit -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glEndlist")
	val glFlush : unit -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glFlush")
	val glFrontFace : GLenum -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glFrontFace")
	val glLightModelf : GLenum -> real -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glLightModelf")
	val glLightModeli : GLenum -> int -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glLightModeli")
	val glLightModelfv : GLenum -> realrgbacolour -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glLightModelfv")
	val glLightModeliv : GLenum -> intrgbacolour -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glLightModeliv")
	val glLightf : GLenum -> GLenum -> real -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glLightf")
	val glLighti : GLenum -> GLenum -> int -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glLighti")
	val glLightfv : GLenum -> GLenum -> realrgbacolour -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glLightfv")
	val glLightiv : GLenum -> GLenum -> intrgbacolour -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glLightiv")
	val glLoadIdentity : unit -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glLoadIdentity")
	val glMatrixMode : GLenum -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glMatrixMode")
	val glNewList : int -> GLenum -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glNewlist")
	val glOrthoApp : real * real * real * real * real * real -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glOrtho")
	fun glOrtho (a0 : real) (a1 : real) (a2 : real) 
	    (a3 : real) (a4 : real) (a5 : real) =
		glOrthoApp (a0, a1, a2, a3, a4, a5)
	val glPushMatrix : unit -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glPushMatrix")
	val glPolygonMode : GLenum -> GLenum -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glPolygonMode")
	val glPopMatrix : unit -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glPopMatrix")
	val glRectd : real -> real -> real -> real -> unit =
		Dynlib.app4 (Dynlib.dlsym dlh "mosml_glRectd")
	val glRectf : real -> real -> real -> real -> unit =
		Dynlib.app4 (Dynlib.dlsym dlh "mosml_glRectd")
	val glRotated : real -> real -> real -> real -> unit =
		Dynlib.app4 (Dynlib.dlsym dlh "mosml_glRotated")
	val glRotatef : real -> real -> real -> real -> unit =
		Dynlib.app4 (Dynlib.dlsym dlh "mosml_glRotated")
	val glShadeModel : GLenum -> unit =
		Dynlib.app1 (Dynlib.dlsym dlh "mosml_glShadeModel")
	val glTranslated : real -> real -> real -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glTranslated")
	val glTranslatef : real -> real -> real -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glTranslated")
	val glVertex2d : real -> real -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glVertex2d")
	val glVertex3d : real -> real -> real -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glVertex3d")
	val glVertex2f : real -> real -> unit =
		Dynlib.app2 (Dynlib.dlsym dlh "mosml_glVertex2d")
	val glVertex3f : real -> real -> real -> unit =
		Dynlib.app3 (Dynlib.dlsym dlh "mosml_glVertex3d")
	val glViewport : int -> int -> int -> int -> unit =
		Dynlib.app4 (Dynlib.dlsym dlh "mosml_glViewport")
