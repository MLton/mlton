...
*)
        ...
        val GLU_EDGE_FLAG = GLU_TESS_EDGE_FLAG
            val c_gluOrtho2D = _import "gluOrtho2D" stdcall: GL.GLreal * GL.GLreal * GL.GLreal * GL.GLreal -> unit;
            fun gluOrtho2D (a:GL.GLreal) (b:GL.GLreal) (c:GL.GLreal) (d:GL.GLreal)
