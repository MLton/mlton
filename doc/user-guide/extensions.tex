...
For more details, see \secref{profiling} and {\tt examples/profiling}.
In order to most efficiently execute non-profiled programs, all of the
operations in {\tt MLton.Profile} are no-ops when compiling {\tt
-profile false}.
...
default scheduling mechanism, and can be used to implement both
