...
\option{-codegen \choiceThree{native}{bytecode}{c}}
Generate native code, byte code, or C code.  With {\tt -codegen
...
Ignore the specified annotation in every {\tt mlb} file.  For example,
to see {\em all} match and unused warnings, use {\tt -disable-ann
...
\option{-target-link-opt {\it os} {\it opt}}
