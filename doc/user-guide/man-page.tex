...
and {\tt 2002-strict} implement the current Basis Library
specification; {\tt 2002-strict} removes all extensions described in
\secref{mlton}.  {\tt 1997} implements a previous version of the Basis
Library specification; see \secref{basis1997} for more information.
{\tt none} removes all Basis Library functionality; the only bound
identifier is {\tt =} corresponding to polymorphic equality.
