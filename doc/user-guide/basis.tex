...
Basis Library specification, available at \link{\makeurl{basis/}}.
By default, {\mlton} makes this library available to user programs.
The original version of the specification comes from
\link{http://www.StandardML.org/Basis/}, which may have been updated
since this release of {\mlton}.
