...
library.  Both the 1997 and 2002 basis library specifications are
available via the {\tt -basis} switch.  A few functions are missing
from {\tt BinIO}, {\tt OS.Path}, {\tt Real}, {\tt StreamIO}, and {\tt
TextIO}.  See \secref{basis-library} for details.
...
\feature{source-level profiling}
{\mlton} has support for source-level profiling and can profile both
time and allocation.  See \secref{profiling} for details.
