...
In {\mlton}, integers are use 32 bits and integer arithmetic does not have any
overhead due to tagging.

\feature{unboxed native arrays}
In {\mlton}, an array of integers or reals uses the natural C-like
