...
* 2015-06-22
  ** Introduce an MLB annotation to control elaboration of `val rec` and `fun`
  declarations that redefine identifiers that previously had constructor status:
...
* 2007-02-25
  ** Change amd64-* target platforms from 32-bit compatability mode (i.e.,
