...
val (piGet, piSet) = _symbol "Real64_Math_pi" internal : (unit -> (Real64.t)) * ((Real64.t) -> unit);
val pow = _import "Real64_Math_pow" internal : Real64.t * Real64.t -> Real64.t;
val sin = _import "Real64_Math_sin" internal : Real64.t -> Real64.t;
val sinh = _import "Real64_Math_sinh" internal : Real64.t -> Real64.t;
val sqrt = _import "Real64_Math_sqrt" internal : Real64.t -> Real64.t;
val tan = _import "Real64_Math_tan" internal : Real64.t -> Real64.t;
val tanh = _import "Real64_Math_tanh" internal : Real64.t -> Real64.t;
end
val (maxFiniteGet, maxFiniteSet) = _symbol "Real64_maxFinite" internal : (unit -> (Real64.t)) * ((Real64.t) -> unit);
val (minNormalPosGet, minNormalPosSet) = _symbol "Real64_minNormalPos" internal : (unit -> (Real64.t)) * ((Real64.t) -> unit);
val (minPosGet, minPosSet) = _symbol "Real64_minPos" internal : (unit -> (Real64.t)) * ((Real64.t) -> unit);
val modf = _import "Real64_modf" internal : Real64.t * (Real64.t) ref -> Real64.t;
val move = _import "Real64_move" internal : (Real64.t) ref * (Real64.t) ref -> unit;
val mul = _import "Real64_mul" internal : Real64.t * Real64.t -> Real64.t;
val muladd = _import "Real64_muladd" internal : Real64.t * Real64.t * Real64.t -> Real64.t;
val mulsub = _import "Real64_mulsub" internal : Real64.t * Real64.t * Real64.t -> Real64.t;
val neg = _import "Real64_neg" internal : Real64.t -> Real64.t;
val rndToReal32 = _import "Real64_rndToReal32" internal : Real64.t -> Real32.t;
val rndToReal64 = _import "Real64_rndToReal64" internal : Real64.t -> Real64.t;
val rndToWordS16 = _import "Real64_rndToWordS16" internal : Real64.t -> Int16.t;
val rndToWordS32 = _import "Real64_rndToWordS32" internal : Real64.t -> Int32.t;
val rndToWordS64 = _import "Real64_rndToWordS64" internal : Real64.t -> Int64.t;
val rndToWordS8 = _import "Real64_rndToWordS8" internal : Real64.t -> Int8.t;
val rndToWordU16 = _import "Real64_rndToWordU16" internal : Real64.t -> Word16.t;
val rndToWordU32 = _import "Real64_rndToWordU32" internal : Real64.t -> Word32.t;
val rndToWordU64 = _import "Real64_rndToWordU64" internal : Real64.t -> Word64.t;
val rndToWordU8 = _import "Real64_rndToWordU8" internal : Real64.t -> Word8.t;
val round = _import "Real64_round" internal : Real64.t -> Real64.t;
val signBit = _import "Real64_signBit" internal : Real64.t -> C_Int.t;
val store = _import "Real64_store" internal : (Real64.t) ref * Real64.t -> unit;
val strto = _import "Real64_strto" internal : NullString8.t * C_Int.t -> Real64.t;
val sub = _import "Real64_sub" internal : Real64.t * Real64.t -> Real64.t;
end
structure Socket = 
struct
val accept = _import "Socket_accept" internal : C_Sock.t * (Word8.t) array * (C_Socklen.t) ref -> (C_Int.t) C_Errno.t;
structure AF = 
struct
...
val bind = _import "Socket_bind" internal : C_Sock.t * (Word8.t) vector * C_Socklen.t -> (C_Int.t) C_Errno.t;
val close = _import "Socket_close" internal : C_Sock.t -> (C_Int.t) C_Errno.t;
val connect = _import "Socket_connect" internal : C_Sock.t * (Word8.t) vector * C_Socklen.t -> (C_Int.t) C_Errno.t;
structure Ctl = 
struct
val FIONBIO = _const "Socket_Ctl_FIONBIO" : C_Int.t;
val FIONREAD = _const "Socket_Ctl_FIONREAD" : C_Int.t;
val getIOCtl = _import "Socket_Ctl_getIOCtl" internal : C_Sock.t * C_Int.t * (Word8.t) array -> (C_Int.t) C_Errno.t;
val getPeerName = _import "Socket_Ctl_getPeerName" internal : C_Sock.t * (Word8.t) array * (C_Socklen.t) ref -> (C_Int.t) C_Errno.t;
val getSockName = _import "Socket_Ctl_getSockName" internal : C_Sock.t * (Word8.t) array * (C_Socklen.t) ref -> (C_Int.t) C_Errno.t;
val getSockOpt = _import "Socket_Ctl_getSockOpt" internal : C_Sock.t * C_Int.t * C_Int.t * (Word8.t) array * (C_Socklen.t) ref -> (C_Int.t) C_Errno.t;
val setIOCtl = _import "Socket_Ctl_setIOCtl" internal : C_Sock.t * C_Int.t * (Word8.t) vector -> (C_Int.t) C_Errno.t;
val setSockOpt = _import "Socket_Ctl_setSockOpt" internal : C_Sock.t * C_Int.t * C_Int.t * (Word8.t) vector * C_Socklen.t -> (C_Int.t) C_Errno.t;
...
val familyOfAddr = _import "Socket_familyOfAddr" internal : (Word8.t) vector -> C_Int.t;
structure GenericSock = 
struct
val socket = _import "Socket_GenericSock_socket" internal : C_Int.t * C_Int.t * C_Int.t -> (C_Int.t) C_Errno.t;
val socketPair = _import "Socket_GenericSock_socketPair" internal : C_Int.t * C_Int.t * C_Int.t * (C_Int.t) array -> (C_Int.t) C_Errno.t;
end
val getTimeout_sec = _import "Socket_getTimeout_sec" internal : unit -> C_Time.t;
val getTimeout_usec = _import "Socket_getTimeout_usec" internal : unit -> C_SUSeconds.t;
structure INetSock = 
struct
structure Ctl = 
struct
...
val fromAddr = _import "Socket_INetSock_fromAddr" internal : (Word8.t) vector -> unit;
val getInAddr = _import "Socket_INetSock_getInAddr" internal : (Word8.t) array -> unit;
val getPort = _import "Socket_INetSock_getPort" internal : unit -> Word16.t;
val toAddr = _import "Socket_INetSock_toAddr" internal : (Word8.t) vector * Word16.t * (Word8.t) array * (C_Socklen.t) ref -> unit;
end
val listen = _import "Socket_listen" internal : C_Sock.t * C_Int.t -> (C_Int.t) C_Errno.t;
...
val recv = _import "Socket_recv" internal : C_Sock.t * (Word8.t) array * C_Int.t * C_Size.t * C_Int.t -> (C_SSize.t) C_Errno.t;
val recvFrom = _import "Socket_recvFrom" internal : C_Sock.t * (Word8.t) array * C_Int.t * C_Size.t * C_Int.t * (Word8.t) array * (C_Socklen.t) ref -> (C_SSize.t) C_Errno.t;
val select = _import "Socket_select" internal : (C_Fd.t) vector * (C_Fd.t) vector * (C_Fd.t) vector * (C_Int.t) array * (C_Int.t) array * (C_Int.t) array -> (C_Int.t) C_Errno.t;
val sendArr = _import "Socket_sendArr" internal : C_Sock.t * (Word8.t) array * C_Int.t * C_Size.t * C_Int.t -> (C_SSize.t) C_Errno.t;
val sendArrTo = _import "Socket_sendArrTo" internal : C_Sock.t * (Word8.t) array * C_Int.t * C_Size.t * C_Int.t * (Word8.t) vector * C_Socklen.t -> (C_SSize.t) C_Errno.t;
val sendVec = _import "Socket_sendVec" internal : C_Sock.t * (Word8.t) vector * C_Int.t * C_Size.t * C_Int.t -> (C_SSize.t) C_Errno.t;
val sendVecTo = _import "Socket_sendVecTo" internal : C_Sock.t * (Word8.t) vector * C_Int.t * C_Size.t * C_Int.t * (Word8.t) vector * C_Socklen.t -> (C_SSize.t) C_Errno.t;
val setTimeout = _import "Socket_setTimeout" internal : C_Time.t * C_SUSeconds.t -> unit;
val setTimeoutNull = _import "Socket_setTimeoutNull" internal : unit -> unit;
...
val shutdown = _import "Socket_shutdown" internal : C_Sock.t * C_Int.t -> (C_Int.t) C_Errno.t;
structure SOCK = 
struct
...
structure UnixSock = 
struct
val fromAddr = _import "Socket_UnixSock_fromAddr" internal : (Word8.t) vector * (Char8.t) array * C_Size.t -> unit;
val pathLen = _import "Socket_UnixSock_pathLen" internal : (Word8.t) vector -> C_Size.t;
val toAddr = _import "Socket_UnixSock_toAddr" internal : NullString8.t * C_Size.t * (Word8.t) array * (C_Socklen.t) ref -> unit;
end
end
structure Stdio = 
struct
val print = _import "Stdio_print" internal : String8.t -> unit;
val printStderr = _import "Stdio_printStderr" internal : String8.t -> unit;
val printStdout = _import "Stdio_printStdout" internal : String8.t -> unit;
end
structure Time = 
struct
val getTimeOfDay = _import "Time_getTimeOfDay" internal : (C_Time.t) ref * (C_SUSeconds.t) ref -> C_Int.t;
end
structure Windows = 
struct
structure Process = 
struct
val create = _import "Windows_Process_create" internal : NullString8.t * NullString8.t * NullString8.t * C_Fd.t * C_Fd.t * C_Fd.t -> (C_PId.t) C_Errno.t;
val terminate = _import "Windows_Process_terminate" internal : C_PId.t * C_Signal.t -> (C_Int.t) C_Errno.t;
end
end
structure Word16 = 
struct
type t = Word16.t
val add = _import "Word16_add" internal : Word16.t * Word16.t -> Word16.t;
val andb = _import "Word16_andb" internal : Word16.t * Word16.t -> Word16.t;
val equal = _import "Word16_equal" internal : Word16.t * Word16.t -> Bool.t;
val lshift = _import "Word16_lshift" internal : Word16.t * Word32.t -> Word16.t;
val neg = _import "Word16_neg" internal : Word16.t -> Word16.t;
val notb = _import "Word16_notb" internal : Word16.t -> Word16.t;
val orb = _import "Word16_orb" internal : Word16.t * Word16.t -> Word16.t;
val rol = _import "Word16_rol" internal : Word16.t * Word32.t -> Word16.t;
val ror = _import "Word16_ror" internal : Word16.t * Word32.t -> Word16.t;
val sub = _import "Word16_sub" internal : Word16.t * Word16.t -> Word16.t;
val xorb = _import "Word16_xorb" internal : Word16.t * Word16.t -> Word16.t;
end
structure Word32 = 
struct
type t = Word32.t
val add = _import "Word32_add" internal : Word32.t * Word32.t -> Word32.t;
val andb = _import "Word32_andb" internal : Word32.t * Word32.t -> Word32.t;
val castToReal32 = _import "Word32_castToReal32" internal : Word32.t -> Real32.t;
val equal = _import "Word32_equal" internal : Word32.t * Word32.t -> Bool.t;
val lshift = _import "Word32_lshift" internal : Word32.t * Word32.t -> Word32.t;
val neg = _import "Word32_neg" internal : Word32.t -> Word32.t;
val notb = _import "Word32_notb" internal : Word32.t -> Word32.t;
val orb = _import "Word32_orb" internal : Word32.t * Word32.t -> Word32.t;
val rol = _import "Word32_rol" internal : Word32.t * Word32.t -> Word32.t;
val ror = _import "Word32_ror" internal : Word32.t * Word32.t -> Word32.t;
val sub = _import "Word32_sub" internal : Word32.t * Word32.t -> Word32.t;
val xorb = _import "Word32_xorb" internal : Word32.t * Word32.t -> Word32.t;
end
structure Word64 = 
struct
type t = Word64.t
val add = _import "Word64_add" internal : Word64.t * Word64.t -> Word64.t;
val andb = _import "Word64_andb" internal : Word64.t * Word64.t -> Word64.t;
val castToReal64 = _import "Word64_castToReal64" internal : Word64.t -> Real64.t;
val equal = _import "Word64_equal" internal : Word64.t * Word64.t -> Bool.t;
val fetch = _import "Word64_fetch" internal : (Word64.t) ref -> Word64.t;
val lshift = _import "Word64_lshift" internal : Word64.t * Word32.t -> Word64.t;
val move = _import "Word64_move" internal : (Word64.t) ref * (Word64.t) ref -> unit;
val neg = _import "Word64_neg" internal : Word64.t -> Word64.t;
val notb = _import "Word64_notb" internal : Word64.t -> Word64.t;
val orb = _import "Word64_orb" internal : Word64.t * Word64.t -> Word64.t;
val rol = _import "Word64_rol" internal : Word64.t * Word32.t -> Word64.t;
val ror = _import "Word64_ror" internal : Word64.t * Word32.t -> Word64.t;
val store = _import "Word64_store" internal : (Word64.t) ref * Word64.t -> unit;
val sub = _import "Word64_sub" internal : Word64.t * Word64.t -> Word64.t;
val xorb = _import "Word64_xorb" internal : Word64.t * Word64.t -> Word64.t;
end
structure Word8 = 
struct
type t = Word8.t
val add = _import "Word8_add" internal : Word8.t * Word8.t -> Word8.t;
val andb = _import "Word8_andb" internal : Word8.t * Word8.t -> Word8.t;
val equal = _import "Word8_equal" internal : Word8.t * Word8.t -> Bool.t;
val lshift = _import "Word8_lshift" internal : Word8.t * Word32.t -> Word8.t;
val neg = _import "Word8_neg" internal : Word8.t -> Word8.t;
val notb = _import "Word8_notb" internal : Word8.t -> Word8.t;
val orb = _import "Word8_orb" internal : Word8.t * Word8.t -> Word8.t;
val rol = _import "Word8_rol" internal : Word8.t * Word32.t -> Word8.t;
val ror = _import "Word8_ror" internal : Word8.t * Word32.t -> Word8.t;
val sub = _import "Word8_sub" internal : Word8.t * Word8.t -> Word8.t;
val xorb = _import "Word8_xorb" internal : Word8.t * Word8.t -> Word8.t;
end
structure WordS16 = 
struct
val addCheckOverflows = _import "WordS16_addCheckOverflows" internal : Int16.t * Int16.t -> Bool.t;
val extdToWord16 = _import "WordS16_extdToWord16" internal : Int16.t -> Word16.t;
val extdToWord32 = _import "WordS16_extdToWord32" internal : Int16.t -> Word32.t;
val extdToWord64 = _import "WordS16_extdToWord64" internal : Int16.t -> Word64.t;
val extdToWord8 = _import "WordS16_extdToWord8" internal : Int16.t -> Word8.t;
val ge = _import "WordS16_ge" internal : Int16.t * Int16.t -> Bool.t;
val gt = _import "WordS16_gt" internal : Int16.t * Int16.t -> Bool.t;
val le = _import "WordS16_le" internal : Int16.t * Int16.t -> Bool.t;
val lt = _import "WordS16_lt" internal : Int16.t * Int16.t -> Bool.t;
val mul = _import "WordS16_mul" internal : Int16.t * Int16.t -> Int16.t;
val mulCheckOverflows = _import "WordS16_mulCheckOverflows" internal : Int16.t * Int16.t -> Bool.t;
val negCheckOverflows = _import "WordS16_negCheckOverflows" internal : Int16.t -> Bool.t;
val quot = _import "WordS16_quot" internal : Int16.t * Int16.t -> Int16.t;
val rem = _import "WordS16_rem" internal : Int16.t * Int16.t -> Int16.t;
val rndToReal32 = _import "WordS16_rndToReal32" internal : Int16.t -> Real32.t;
val rndToReal64 = _import "WordS16_rndToReal64" internal : Int16.t -> Real64.t;
val rshift = _import "WordS16_rshift" internal : Int16.t * Word32.t -> Int16.t;
val subCheckOverflows = _import "WordS16_subCheckOverflows" internal : Int16.t * Int16.t -> Bool.t;
end
structure WordS32 = 
struct
val addCheckOverflows = _import "WordS32_addCheckOverflows" internal : Int32.t * Int32.t -> Bool.t;
val extdToWord16 = _import "WordS32_extdToWord16" internal : Int32.t -> Word16.t;
val extdToWord32 = _import "WordS32_extdToWord32" internal : Int32.t -> Word32.t;
val extdToWord64 = _import "WordS32_extdToWord64" internal : Int32.t -> Word64.t;
val extdToWord8 = _import "WordS32_extdToWord8" internal : Int32.t -> Word8.t;
val ge = _import "WordS32_ge" internal : Int32.t * Int32.t -> Bool.t;
val gt = _import "WordS32_gt" internal : Int32.t * Int32.t -> Bool.t;
val le = _import "WordS32_le" internal : Int32.t * Int32.t -> Bool.t;
val lt = _import "WordS32_lt" internal : Int32.t * Int32.t -> Bool.t;
val mul = _import "WordS32_mul" internal : Int32.t * Int32.t -> Int32.t;
val mulCheckOverflows = _import "WordS32_mulCheckOverflows" internal : Int32.t * Int32.t -> Bool.t;
val negCheckOverflows = _import "WordS32_negCheckOverflows" internal : Int32.t -> Bool.t;
val quot = _import "WordS32_quot" internal : Int32.t * Int32.t -> Int32.t;
val rem = _import "WordS32_rem" internal : Int32.t * Int32.t -> Int32.t;
val rndToReal32 = _import "WordS32_rndToReal32" internal : Int32.t -> Real32.t;
val rndToReal64 = _import "WordS32_rndToReal64" internal : Int32.t -> Real64.t;
val rshift = _import "WordS32_rshift" internal : Int32.t * Word32.t -> Int32.t;
val subCheckOverflows = _import "WordS32_subCheckOverflows" internal : Int32.t * Int32.t -> Bool.t;
end
structure WordS64 = 
struct
val addCheckOverflows = _import "WordS64_addCheckOverflows" internal : Int64.t * Int64.t -> Bool.t;
val extdToWord16 = _import "WordS64_extdToWord16" internal : Int64.t -> Word16.t;
val extdToWord32 = _import "WordS64_extdToWord32" internal : Int64.t -> Word32.t;
val extdToWord64 = _import "WordS64_extdToWord64" internal : Int64.t -> Word64.t;
val extdToWord8 = _import "WordS64_extdToWord8" internal : Int64.t -> Word8.t;
val ge = _import "WordS64_ge" internal : Int64.t * Int64.t -> Bool.t;
val gt = _import "WordS64_gt" internal : Int64.t * Int64.t -> Bool.t;
val le = _import "WordS64_le" internal : Int64.t * Int64.t -> Bool.t;
val lt = _import "WordS64_lt" internal : Int64.t * Int64.t -> Bool.t;
val mul = _import "WordS64_mul" internal : Int64.t * Int64.t -> Int64.t;
val mulCheckOverflows = _import "WordS64_mulCheckOverflows" internal : Int64.t * Int64.t -> Bool.t;
val negCheckOverflows = _import "WordS64_negCheckOverflows" internal : Int64.t -> Bool.t;
val quot = _import "WordS64_quot" internal : Int64.t * Int64.t -> Int64.t;
val rem = _import "WordS64_rem" internal : Int64.t * Int64.t -> Int64.t;
val rndToReal32 = _import "WordS64_rndToReal32" internal : Int64.t -> Real32.t;
val rndToReal64 = _import "WordS64_rndToReal64" internal : Int64.t -> Real64.t;
val rshift = _import "WordS64_rshift" internal : Int64.t * Word32.t -> Int64.t;
val subCheckOverflows = _import "WordS64_subCheckOverflows" internal : Int64.t * Int64.t -> Bool.t;
end
structure WordS8 = 
struct
val addCheckOverflows = _import "WordS8_addCheckOverflows" internal : Int8.t * Int8.t -> Bool.t;
val extdToWord16 = _import "WordS8_extdToWord16" internal : Int8.t -> Word16.t;
val extdToWord32 = _import "WordS8_extdToWord32" internal : Int8.t -> Word32.t;
val extdToWord64 = _import "WordS8_extdToWord64" internal : Int8.t -> Word64.t;
val extdToWord8 = _import "WordS8_extdToWord8" internal : Int8.t -> Word8.t;
val ge = _import "WordS8_ge" internal : Int8.t * Int8.t -> Bool.t;
val gt = _import "WordS8_gt" internal : Int8.t * Int8.t -> Bool.t;
val le = _import "WordS8_le" internal : Int8.t * Int8.t -> Bool.t;
val lt = _import "WordS8_lt" internal : Int8.t * Int8.t -> Bool.t;
val mul = _import "WordS8_mul" internal : Int8.t * Int8.t -> Int8.t;
val mulCheckOverflows = _import "WordS8_mulCheckOverflows" internal : Int8.t * Int8.t -> Bool.t;
val negCheckOverflows = _import "WordS8_negCheckOverflows" internal : Int8.t -> Bool.t;
val quot = _import "WordS8_quot" internal : Int8.t * Int8.t -> Int8.t;
val rem = _import "WordS8_rem" internal : Int8.t * Int8.t -> Int8.t;
val rndToReal32 = _import "WordS8_rndToReal32" internal : Int8.t -> Real32.t;
val rndToReal64 = _import "WordS8_rndToReal64" internal : Int8.t -> Real64.t;
val rshift = _import "WordS8_rshift" internal : Int8.t * Word32.t -> Int8.t;
val subCheckOverflows = _import "WordS8_subCheckOverflows" internal : Int8.t * Int8.t -> Bool.t;
end
structure WordU16 = 
struct
val addCheckOverflows = _import "WordU16_addCheckOverflows" internal : Word16.t * Word16.t -> Bool.t;
val extdToWord16 = _import "WordU16_extdToWord16" internal : Word16.t -> Word16.t;
val extdToWord32 = _import "WordU16_extdToWord32" internal : Word16.t -> Word32.t;
val extdToWord64 = _import "WordU16_extdToWord64" internal : Word16.t -> Word64.t;
val extdToWord8 = _import "WordU16_extdToWord8" internal : Word16.t -> Word8.t;
val ge = _import "WordU16_ge" internal : Word16.t * Word16.t -> Bool.t;
val gt = _import "WordU16_gt" internal : Word16.t * Word16.t -> Bool.t;
val le = _import "WordU16_le" internal : Word16.t * Word16.t -> Bool.t;
val lt = _import "WordU16_lt" internal : Word16.t * Word16.t -> Bool.t;
val mul = _import "WordU16_mul" internal : Word16.t * Word16.t -> Word16.t;
val mulCheckOverflows = _import "WordU16_mulCheckOverflows" internal : Word16.t * Word16.t -> Bool.t;
val quot = _import "WordU16_quot" internal : Word16.t * Word16.t -> Word16.t;
val rem = _import "WordU16_rem" internal : Word16.t * Word16.t -> Word16.t;
val rndToReal32 = _import "WordU16_rndToReal32" internal : Word16.t -> Real32.t;
val rndToReal64 = _import "WordU16_rndToReal64" internal : Word16.t -> Real64.t;
val rshift = _import "WordU16_rshift" internal : Word16.t * Word32.t -> Word16.t;
end
structure WordU32 = 
struct
val addCheckOverflows = _import "WordU32_addCheckOverflows" internal : Word32.t * Word32.t -> Bool.t;
val extdToWord16 = _import "WordU32_extdToWord16" internal : Word32.t -> Word16.t;
val extdToWord32 = _import "WordU32_extdToWord32" internal : Word32.t -> Word32.t;
val extdToWord64 = _import "WordU32_extdToWord64" internal : Word32.t -> Word64.t;
val extdToWord8 = _import "WordU32_extdToWord8" internal : Word32.t -> Word8.t;
val ge = _import "WordU32_ge" internal : Word32.t * Word32.t -> Bool.t;
val gt = _import "WordU32_gt" internal : Word32.t * Word32.t -> Bool.t;
val le = _import "WordU32_le" internal : Word32.t * Word32.t -> Bool.t;
val lt = _import "WordU32_lt" internal : Word32.t * Word32.t -> Bool.t;
val mul = _import "WordU32_mul" internal : Word32.t * Word32.t -> Word32.t;
val mulCheckOverflows = _import "WordU32_mulCheckOverflows" internal : Word32.t * Word32.t -> Bool.t;
val quot = _import "WordU32_quot" internal : Word32.t * Word32.t -> Word32.t;
val rem = _import "WordU32_rem" internal : Word32.t * Word32.t -> Word32.t;
val rndToReal32 = _import "WordU32_rndToReal32" internal : Word32.t -> Real32.t;
val rndToReal64 = _import "WordU32_rndToReal64" internal : Word32.t -> Real64.t;
val rshift = _import "WordU32_rshift" internal : Word32.t * Word32.t -> Word32.t;
end
structure WordU64 = 
struct
val addCheckOverflows = _import "WordU64_addCheckOverflows" internal : Word64.t * Word64.t -> Bool.t;
val extdToWord16 = _import "WordU64_extdToWord16" internal : Word64.t -> Word16.t;
val extdToWord32 = _import "WordU64_extdToWord32" internal : Word64.t -> Word32.t;
val extdToWord64 = _import "WordU64_extdToWord64" internal : Word64.t -> Word64.t;
val extdToWord8 = _import "WordU64_extdToWord8" internal : Word64.t -> Word8.t;
val ge = _import "WordU64_ge" internal : Word64.t * Word64.t -> Bool.t;
val gt = _import "WordU64_gt" internal : Word64.t * Word64.t -> Bool.t;
val le = _import "WordU64_le" internal : Word64.t * Word64.t -> Bool.t;
val lt = _import "WordU64_lt" internal : Word64.t * Word64.t -> Bool.t;
val mul = _import "WordU64_mul" internal : Word64.t * Word64.t -> Word64.t;
val mulCheckOverflows = _import "WordU64_mulCheckOverflows" internal : Word64.t * Word64.t -> Bool.t;
val quot = _import "WordU64_quot" internal : Word64.t * Word64.t -> Word64.t;
val rem = _import "WordU64_rem" internal : Word64.t * Word64.t -> Word64.t;
val rndToReal32 = _import "WordU64_rndToReal32" internal : Word64.t -> Real32.t;
val rndToReal64 = _import "WordU64_rndToReal64" internal : Word64.t -> Real64.t;
val rshift = _import "WordU64_rshift" internal : Word64.t * Word32.t -> Word64.t;
end
structure WordU8 = 
struct
val addCheckOverflows = _import "WordU8_addCheckOverflows" internal : Word8.t * Word8.t -> Bool.t;
val extdToWord16 = _import "WordU8_extdToWord16" internal : Word8.t -> Word16.t;
val extdToWord32 = _import "WordU8_extdToWord32" internal : Word8.t -> Word32.t;
val extdToWord64 = _import "WordU8_extdToWord64" internal : Word8.t -> Word64.t;
val extdToWord8 = _import "WordU8_extdToWord8" internal : Word8.t -> Word8.t;
val ge = _import "WordU8_ge" internal : Word8.t * Word8.t -> Bool.t;
val gt = _import "WordU8_gt" internal : Word8.t * Word8.t -> Bool.t;
val le = _import "WordU8_le" internal : Word8.t * Word8.t -> Bool.t;
val lt = _import "WordU8_lt" internal : Word8.t * Word8.t -> Bool.t;
val mul = _import "WordU8_mul" internal : Word8.t * Word8.t -> Word8.t;
val mulCheckOverflows = _import "WordU8_mulCheckOverflows" internal : Word8.t * Word8.t -> Bool.t;
val quot = _import "WordU8_quot" internal : Word8.t * Word8.t -> Word8.t;
val rem = _import "WordU8_rem" internal : Word8.t * Word8.t -> Word8.t;
val rndToReal32 = _import "WordU8_rndToReal32" internal : Word8.t -> Real32.t;
val rndToReal64 = _import "WordU8_rndToReal64" internal : Word8.t -> Real64.t;
val rshift = _import "WordU8_rshift" internal : Word8.t * Word32.t -> Word8.t;
end
end
end
