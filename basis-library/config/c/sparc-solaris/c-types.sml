...
structure C_GId = struct open Int32 type t = int end
functor C_GId_ChooseIntN (A: CHOOSE_INTN_ARG) = ChooseIntN_Int32 (A)
...
structure C_UId = struct open Int32 type t = int end
functor C_UId_ChooseIntN (A: CHOOSE_INTN_ARG) = ChooseIntN_Int32 (A)
